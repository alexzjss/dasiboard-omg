...
('hype',         'HypE — Hub de Pesquisa', 'HypE',
 ...
 'research',  '#f59e0b', '🤖', 'https://instagram.com/hype.each', NULL),
('conway',       'Conway Game Studio', 'Conway',
 ...
 'tech',      '#22c55e', '🎮', 'https://instagram.com/conway.each', NULL),
('codelab',      'CodeLab Leste', 'CodeLab',
 ...
 'tech',      '#06b6d4', '⚙️', 'https://instagram.com/codelableste', NULL),
('sintese',      'Síntese Jr.', 'Síntese Jr.',
 ...
 'empresa',   '#ec4899', '💼', 'https://instagram.com/sintesejr', 'contato@sintesejr.com.br'),
...
('pet-si',       'PET-SI — Programa de Educação Tutorial', 'PET-SI',
 ...
 'research',  '#4d67f5', '📚', 'https://instagram.com/pet.si.each', 'pet-si@usp.br'),
