...
('each-in-shell','EACH in the Shell',                             'EITS',    'Grupo dedicado à segurança da informação, hacking ético e CTF (Capture The Flag). Realiza workshops, treinamentos e competições de cybersegurança, formando profissionais na área.', 'tech',         '#ef4444', '💻', 'https://instagram.com/eachintheshell', NULL),
('hype',         'Hype — Dados & IA',                        'Hyé',         'Centro de estudos e projetos em Ciência de Dados, Inteligência Artificial e Machine Learning. Desenvolve pesquisas aplicadas, realiza hackathons e conecta estudantes ao mercado de dados.', 'research',     '#f59e0b', '🤖', 'https://instagram.com/hype.each', NULL),
('conway',       'Conway',                            'Conway',       'Grupo de desenvolvimento de jogos digitais e computação gráfica. Cria jogos, realiza game jams, explora engines como Unity e Godot, e estuda fundamentos de CG e rendering.', 'tech',         '#22c55e', '🎮', 'https://instagram.com/conway.each', NULL),
...
('pet-si',       'PET-SI',        'PET-SI',       'Programa de Educação Tutorial de Sistemas de Informação, financiado pelo MEC/SESu. Desenvolve atividades de pesquisa, ensino e extensão, promovendo formação acadêmica de excelência.', 'research',     '#4d67f5', '📚', 'https://instagram.com/pet.si.each', 'pet-si@usp.br'),
