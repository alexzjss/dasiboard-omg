...
('each-in-shell','EACH in the Shell',                             'EachShell',  'Grupo dedicado à segurança da informação, hacking ético e CTF. Realiza workshops, treinamentos e competições de cybersegurança.', 'tech',      '#ef4444', '💻', 'https://instagram.com/eachintheshell', NULL),
